...
ml = 4;          % ml:Number of modulation levels (BPSK:ml=1, QPSK:ml=2, 16QAM:ml=4, 64QAM:ml=6)
br = sr .* ml;   % Bit rate
...
for cnt = 1:length(ebn0)
    ...
    for iii=1:nloop
        ...
        [ich,qch]=qam16mod(data1,1,nd,ml);
        ...
        [demodata]=qam16demod(ich6,qch6,1,nd,ml);
