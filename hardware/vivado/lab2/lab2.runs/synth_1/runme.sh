...
HD_PWD='C:/Users/admin/Desktop/System/Study/VLSI/lab2/vivado/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_ifft_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_ifft_top.tcl
